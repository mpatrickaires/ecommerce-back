...
namespace ECommerceBack.Migrations
{
    ...
    [Migration("20231121000252_CriarTabelas_Pedido_PedidoItem")]
    partial class CriarTabelas_Pedido_PedidoItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerceBack.Domain.Entities.CarrinhoItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("ItemId")
                        .HasDatabaseName("ix_carrinho_itens_item_id");

                    b.HasIndex("UsuarioId", "ItemId")
                        .IsUnique()
                        .HasDatabaseName("ix_carrinho_itens_usuario_id_item_id");
            ...
            modelBuilder.Entity("ECommerceBack.Domain.Entities.Pedido", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ECommerceBack.Domain.Entities.PedidoItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<decimal>("PrecoUnitarioItem")
                        .HasColumnType("numeric")
                        .HasColumnName("preco_unitario_item");
                    ...
                    b.HasIndex("ItemId")
                        .HasDatabaseName("ix_pedido_itens_item_id");

                    b.HasIndex("PedidoId", "ItemId")
                        .IsUnique()
                        .HasDatabaseName("ix_pedido_itens_pedido_id_item_id");
            ...
            modelBuilder.Entity("ECommerceBack.Domain.Entities.CarrinhoItem", b =>
                {
                    b.HasOne("ECommerceBack.Domain.Entities.Item", "Item")
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_carrinho_itens_itens_item_id");

                    b.HasOne("ECommerceBack.Domain.Entities.Usuario", "Usuario")
                        .WithMany()
            ...
            modelBuilder.Entity("ECommerceBack.Domain.Entities.PedidoItem", b =>
                {
                    b.HasOne("ECommerceBack.Domain.Entities.Item", "Item")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_pedido_itens_itens_item_id");

                    b.HasOne("ECommerceBack.Domain.Entities.Pedido", "Pedido")
                        .WithMany("Itens")
